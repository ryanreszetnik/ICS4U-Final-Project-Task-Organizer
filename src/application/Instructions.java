...
public class Instructions {
	...
	public static void setup(Pane pane) {
		...
		instructionsText.setText(" - Enter the task name, description, date for the tasks" + "\n"+
				...
				"Calendar"  + "\n" + 
				" - Click on any day in the month showing to show a dropdown where you can add either an event or assignment"  + "\n"+
				...
				" -Click on a task to bring up more details or to edit/delete it\n"+
				" -If you have more tasks that can fit on the screen, use the up and down arrow keys to scroll through them\n"+
